...
async function loadMusicList() {
  ...
  try {
    ...
    musicList.forEach((song, index) => {
      ...
      // 构建音乐URL
      const musicUrl = `https://res.cloudinary.com/dc5rhyjth/raw/upload/${song.musicFileName}`;
      let coverUrl = '';
      let lyricsUrl = '';
      
      if (song.coverFileName) {
        coverUrl = `https://res.cloudinary.com/dc5rhyjth/image/upload/${song.coverFileName}`;
      }
      
      if (song.lyricsFileName) {
        lyricsUrl = `https://res.cloudinary.com/dc5rhyjth/raw/upload/${song.lyricsFileName}`;
      }
      ...
      songCard.innerHTML = `
        ...
        <div class="song-info">
          ...
          <div class="song-actions">
            ...
            <a href="${musicUrl}" download="${song.title}.${getFileExtension(
        song.musicFileName
